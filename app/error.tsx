  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black text-white">
      <Container className="text-center">
        <p className="mb-4 font-mono text-[11px] tracking-[0.4em] uppercase text-white/30">/ System Error</p>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Link href="/" className="border border-white/10 px-8 py-4 font-mono text-[11px] tracking-[0.3em] uppercase text-white/30 hover:border-white/30 hover:text-white/60 transition-all duration-300">
            Home /
          </Link>
        </div>
      </Container>
